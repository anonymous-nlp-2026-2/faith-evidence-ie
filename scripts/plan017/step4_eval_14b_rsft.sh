#!/bin/bash
# Step 4: D076 eval for 14B RSFT (with evidence)
# 14B needs dual GPU device_map="auto"
set -euo pipefail
...
OUTPUT_DIR="/workspace/eval_results/plan017_14b_rsft_eval"
...
echo "=== Step 4: Eval 14B RSFT (with evidence) ==="
